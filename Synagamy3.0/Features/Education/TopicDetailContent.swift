...
struct TopicDetailContent: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: Brand.Spacing.spacing6) {
                ...
                Button(action: {
                    ...
                    HStack(spacing: 10) {
                        Circle()
                            .fill(
                                LinearGradient(
                                    colors: [Brand.Color.primary.opacity(0.2), Brand.Color.primary.opacity(0.1)],
                                    startPoint: .topLeading,
                                    endPoint: .bottomTrailing
                                )
                            )
                    ...
                    .background(
                        RoundedRectangle(cornerRadius: 14, style: .continuous)
                            ...
                            .overlay(
                                RoundedRectangle(cornerRadius: 14, style: .continuous)
                                    .strokeBorder(Brand.Color.hairline.opacity(0.6), lineWidth: 1)
                            )
                    )
                }
                .buttonStyle(.plain)
                ...
                Button(action: {
                    ...
                    HStack(spacing: 10) {
                        Circle()
                            .fill(
                                LinearGradient(
                                    colors: [Brand.Color.secondary.opacity(0.2), Brand.Color.secondary.opacity(0.1)],
                                    startPoint: .topLeading,
                                    endPoint: .bottomTrailing
                                )
                            )
