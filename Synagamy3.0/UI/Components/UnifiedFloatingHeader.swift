...
//  Synagamy3.0
//
//  A unified floating header component that combines the best of LogoHeader and FloatingLogoHeader
//  with consistent styling, proper floating behavior, and optimized performance.
//
