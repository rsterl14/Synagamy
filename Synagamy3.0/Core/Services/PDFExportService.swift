...
class PDFExportService: ObservableObject {
    ...
    func exportCycleData(
        ...
        recommendations: [IntercourseTiming],
    ...
    private var disclaimerSection: some View {
        VStack(alignment: .leading, spacing: 8) {
            ...
            Text("This report is generated by the Synagamy educational fertility app and is intended for informational purposes only. The predictions and recommendations provided should not be used as a substitute for professional medical advice, diagnosis, or treatment. Always consult with qualified healthcare professionals, including reproductive endocrinologists or fertility specialists, for personalized medical guidance regarding fertility, reproductive health, and treatment decisions.")
                .font(.caption)
                .foregroundColor(.secondary)
                .multilineTextAlignment(.leading)
        }
